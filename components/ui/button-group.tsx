...
function ButtonGroupText({
  ...
  return (
    <Comp
      className={cn(
        "tw-:bg-muted tw-:shadow-xs tw-:flex tw-:items-center tw-:gap-2 tw-:rounded-md tw-:border tw-:px-4 tw-:text-sm tw-:font-medium tw-:[&_svg:not([class*=size-])]:size-4 tw-:[&_svg]:pointer-events-none",
        className
      )}
      {...props}
    />
